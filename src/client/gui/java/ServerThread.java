...
- new package nazwa
- wklejamy klasy z klienta do pakietu
- maina usuwamy
- file, project structure, artifacts
- + JAR from modules, klikamy dalej
- BUILD, build artifacts, build "i gotowe"

- przechodzimy do projektu z gui
- project structure, dodajemy nowa biblioteke z javy
- znajdujemy swoj projekt i out, artefakty i wybieramy jar

zeby zadzialalo w kodzie aplikacji
w hello aplication pisze na gorze import nazwapakietu,
potem intellij podpowiada zeby dodac jakies requiers i za nas to robi wiec git

tworze serverthread w aplikacji
